  ...
  return (
    <div className="w-full max-w-2xl mx-auto px-4 py-8 md:py-12 animate-fade-in">
      <div className="bg-white rounded-3xl border border-slate-200/80 shadow-md p-6 sm:p-10">
        ...
        {/* Progress Header */}
        <div className="flex justify-between items-center mb-8 border-b border-slate-100 pb-5" role="progressbar" aria-valuenow={step} aria-valuemin={1} aria-valuemax={4}>
          <div>
